        ...
        <div className='flex flex-wrap items-center lg:gap-y-2 gap-4 w-full'>
          ...
          <div id="collapseMenu"
            ...
            <ul
              ...
              <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                className='text-[#333] hover:text-[#007bff] text-[15px] block font-semibold'>Arrivals</a></li>
              <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                className='text-[#333] hover:text-[#007bff] text-[15px] block font-semibold'>Reviews</a></li>
            </ul>
          </div>
